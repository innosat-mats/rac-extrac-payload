...
func Example() {
	...
	data := []byte{
		//1 A continuation pacage from previous file
		...
		0x00, 0x30, 0xfb,
		//3 Too short buffer (innosat tm header length too short for a STAT)
		0x90, 0xeb, 0x48, 0x00, 0x79, 0xd8, 0x00, 0x00, 0xd9, 0xb0, 0xc8, 0x04, 0xda, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x2e, 0x02, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0xcc, 0xcc,
